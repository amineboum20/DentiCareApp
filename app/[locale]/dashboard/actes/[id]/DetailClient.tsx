...
export default function ActeDetailClient({ acte: initialActe, locale }: Props) {
  ...
  async function handleSave() {
    if (!form.name.trim()) { setFormError(t("errName")); return; }
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6">
          ...
          {suppliersLoading ? (
            ...
            <p className="text-sm text-zinc-400 py-4 text-center">{t("noLinkedSupplier")}</p>
          ) : (
          ...
          <div className="w-full max-w-lg bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl">
            ...
            <div className="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 mb-1">{t("form.durationMin")}</label>
          ...
          <div className="w-full max-w-sm bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl p-6">
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button onClick={handleDelete} disabled={deleting}
                ...
                {deleting ? t("deleting") : t("form.delete")}
              </button>
            </div>
          </div>
        </div>
