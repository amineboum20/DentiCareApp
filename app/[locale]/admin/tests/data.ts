...
export const MODULES: TestModule[] = [
  ...
  },
  {
    id: "subscriptions", icon: "💳", title: "Abonnements", tests: [
      ...
      { id: "TC-075", title: "Onglet Abonnement (propriétaire)", steps: ["Propriétaire → Paramètres", "Se connecter en non-propriétaire, ouvrir Paramètres"], expected: "Propriétaire : « Formule Standard · 199,00 MAD / mois », « +99,00 MAD / mois par utilisateur supplémentaire », « N utilisateurs actifs · prochaine mensualité … », « Période d'essai gratuite jusqu'au … », solde, factures ; non-propriétaire : pas de section Abonnement" },
      ...
      { id: "TC-078", title: "Facture PDF d'abonnement", steps: ["Télécharger une facture depuis l'admin, puis depuis Paramètres → Abonnement"], expected: "Même PDF : émetteur CareApp Group (mentions « provisoires »), facturé à la cabinet, période, ligne abonnement + ligne « Utilisateur(s) supplémentaire(s) » s'il y en a, mensualité, solde précédent, total à payer ou crédit, RIB, pied avec logo" },
      ...
      { id: "TC-086", title: "Utilisateurs supplémentaires facturés", steps: ["Établissement avec 2 membres actifs (approuvés, non désactivés), essai terminé", "Admin → Abonnements → « Générer les factures du mois »", "Télécharger le PDF"], expected: "Facture de 298,00 MAD (199 + 1 × 99) ; PDF : abonnement 199,00 MAD + « Utilisateur supplémentaire : 1 x 99,00 MAD » ; un membre désactivé ou non approuvé n'est pas compté ; Paramètres → Abonnement et « Revenu mensuel » admin affichent le même montant" },
    ],
  },
  {
  ...
  },
  {
    id: "factures", icon: "🧾", title: "Factures, devis & feuilles de soins", tests: [
      ...
      { id: "TC-151", title: "FDS CNSS : chaque valeur dans sa case", steps: ["Patient avec CIN, sexe, date de naissance, adresse, mutuelle CNSS (n° d'immatriculation, lien « Lui même »)", "Dossier avec une facture et une visite faite par un praticien qui a un INPE", "Hub dossier → « 🧾 FDS CNSS », ouvrir le PDF et zoomer sur le volet de droite"], expected: "Nom sur la ligne « Nom et prénom » de l'assuré ET du bénéficiaire (pas sur « Bénéficiaire des soins ») ; immatriculation, CIN (assuré et bénéficiaire) et INP : un caractère par case, au-dessus du trait, dès la 1re case ; date de naissance en JJ | MM | AAAA dans les 3 groupes de cases ; croix au centre des cases « Lui même » et du sexe ; adresse et montant posés sur leurs pointillés, sans chevaucher le texte imprimé" },
      { id: "TC-152", title: "FDS CNOPS : chaque valeur dans sa case", steps: ["Même patient avec mutuelle CNOPS et lien « Conjoint », puis refaire avec « Enfant »", "Hub dossier → « 🧾 FDS CNOPS », ouvrir le PDF et zoomer sur le volet de droite"], expected: "Nom juste après « Nom et prénom : » (assuré et bénéficiaire) sans chevaucher les deux-points ; immatriculation, CIN (assuré et bénéficiaire) et INP : un caractère par case grise ; date de naissance en JJMMAA sur les 6 cases ; croix au centre du rond Conjoint / Enfant et M / F ; adresse et montant posés sur leurs lignes pointillées" },
    ],
  },
  {
