...
export const MODULES: TestModule[] = [
  ...
  },
  {
    id: "subscriptions", icon: "💳", title: "Abonnements", tests: [
      ...
      { id: "TC-078", title: "Facture PDF d'abonnement", steps: ["Télécharger une facture depuis l'admin, puis depuis Paramètres → Abonnement"], expected: "Même PDF : émetteur CareApp Group (mentions « provisoires »), facturé à la cabinet, période, mensualité, solde précédent, total à payer ou crédit, RIB, pied avec logo" },
