...
export const MODULES: TestModule[] = [
  {
    id: "auth", icon: "🔐", title: "Authentification", tests: [
      ...
      { id: "TC-006", title: "Inscription d'un cabinet + confirmation email", steps: ["Ouvrir /fr/signup, remplir le formulaire", "Avant de confirmer : ouvrir /fr/admin", "Cliquer le lien de confirmation reçu, rouvrir /fr/admin"], expected: "Avant confirmation : le cabinet n'apparaît nulle part dans l'admin et aucun email n'est reçu. Après : l'équipe reçoit l'email « Nouvelle inscription » et le cabinet apparaît dans « En attente » avec Approuver" },
  ...
  },
  {
    id: "approvals", icon: "👥", title: "Approbations & membres", tests: [
      ...
      { id: "TC-018", title: "Badge et compteur admin", steps: ["Avoir une inscription confirmée et une non confirmée", "Regarder le badge Approbations et la page Approbations"], expected: "Seule l'inscription confirmée est comptée et affichée ; la non confirmée n'apparaît nulle part dans l'admin" },
